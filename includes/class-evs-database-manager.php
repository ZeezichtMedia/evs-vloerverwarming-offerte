...
class EVS_Database_Manager {
    ...
    public function create_tables() {
        ...
        $quotes_sql = "CREATE TABLE {$this->table_name} (
            ...
            sanding_price DECIMAL(10,2) DEFAULT 0,
    ...
    public function update_quote($quote_id, $quote_data) {
        ...
        if ($result === false) {
            ...
            error_log('EVS Quote Update Failed: ' . $error);
    ...
    private function get_quote_data_formats($data_keys) {
        $formats = [];
        $float_fields = ['total_price', 'verdeler_price', 'drilling_price', 'sealing_price', 'sanding_price', 'strekkende_meter'];
